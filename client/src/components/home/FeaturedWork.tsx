...
const FEATURED_ITEMS = [
    {
        ...
        metric: "2,357 DMs · 212 Leads",
        image: "/assets/images/brands/Aqua-Care/new.jpg",
        path: "/marketing/aqua-care-uae",
        isVideo: false,
        videoUrl: "",
        description: "Managed multi-product Meta Ads engine across 25 campaigns. AED 11.1K spend, 2,357 messaging conversations, 212 Meta leads, 1.21M reach.",
